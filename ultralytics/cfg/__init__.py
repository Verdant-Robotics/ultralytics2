...
TASKS = frozenset({"detect", "segment", "classify", "pose", "obb", "pose-segmentation", "box-inst", "pose-prompt"})
TASK2DATA = {
    "detect": "coco8.yaml",
...
TASK2MODEL = {
    ...
    'pose-prompt': 'yolo11-pose-prompt.yaml'
}
TASK2METRIC = {
    ...
    'pose-prompt': 'metrics/mAP50-95(P)'
}
